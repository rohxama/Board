    ...
    return (
      <div style={{ display: 'grid', placeItems: 'center', height: '100vh', background: '#0f172a', color: '#e2e8f0', fontFamily: 'system-ui, sans-serif', textAlign: 'center', padding: 24 }}>
        <div>
          ...
          <button style={{ background: '#2563eb', color: '#fff', border: 0, borderRadius: 8, padding: '10px 20px', fontSize: 14, cursor: 'pointer' }} onClick={() => this.setState({ error: null })}>Try again</button>
        </div>
      </div>
    )
  }
