...
export function ColorLabHero() {
  return (
    <svg viewBox="0 0 680 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="doc-colorlab-hero" aria-hidden="true">
      ...
      <text x="70" y="52" textAnchor="middle" fontSize="8" fontWeight="600" fontFamily="system-ui" fill={C.blue}>Card</text>

      <circle cx="180" cy="48" r="28" fill="rgba(34,197,94,0.1)" stroke={C.green} strokeWidth="2" />
      <text x="180" y="51" textAnchor="middle" fontSize="8" fontWeight="600" fontFamily="system-ui" fill={C.green}>Status</text>

      <rect x="240" y="24" width="70" height="48" rx="10" fill="rgba(239,68,68,0.1)" stroke={C.red} strokeWidth="2" />
      <text x="275" y="52" textAnchor="middle" fontSize="8" fontWeight="600" fontFamily="system-ui" fill={C.red}>Alert</text>

      <ellipse cx="400" cy="48" rx="38" ry="26" fill="rgba(234,179,8,0.1)" stroke={C.yellow} strokeWidth="2" />
      <text x="400" y="51" textAnchor="middle" fontSize="8" fontWeight="600" fontFamily="system-ui" fill={C.yellow}>Note</text>

      <path d="M480 30 L560 48 L480 66" fill="none" stroke="#8b5cf6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />

      <line x1="480" y1="85" x2="570" y2="85" stroke={C.blue} strokeWidth="2" strokeLinecap="round" />

      {/* Selection handles on the red rect */}
      <rect x="236" y="20" width="8" height="8" rx="2" fill={C.red} />
      <rect x="306" y="20" width="8" height="8" rx="2" fill={C.red} />
      <rect x="236" y="66" width="8" height="8" rx="2" fill={C.red} />
      <rect x="306" y="66" width="8" height="8" rx="2" fill={C.red} />
    </svg>
  )
}
    ...
    <svg viewBox="0 0 520 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="doc-colorlab-demo" aria-hidden="true">
      ...
      <g transform="translate(0, 116)">
        ...
        <g transform="translate(0, 10)">
          <rect width="100" height="48" rx="8" fill={C.surface} stroke={C.border} strokeWidth="1" />
          <rect x="8" y="8" width="36" height="16" rx="3" fill="rgba(59,130,246,0.12)" stroke={C.blue} strokeWidth="1.5" />
          <rect x="8" y="30" width="60" height="4" rx="2" fill={C.muted} opacity="0.2" />
          <rect x="8" y="38" width="40" height="3" rx="1.5" fill={C.muted} opacity="0.12" />
          <text x="50" y="68" textAnchor="middle" fontSize="8" fontWeight="600" fill={C.muted}>Clean</text>
        </g>

        {/* Bold accent */}
        <g transform="translate(120, 10)">
          <rect width="100" height="48" rx="4" fill="rgba(239,68,68,0.08)" stroke={C.red} strokeWidth="3" />
          <rect x="12" y="12" width="40" height="24" rx="3" fill={C.red} opacity="0.15" />
          <rect x="60" y="12" width="28" height="4" rx="2" fill={C.muted} opacity="0.2" />
          <rect x="60" y="22" width="20" height="3" rx="1.5" fill={C.muted} opacity="0.12" />
          <text x="50" y="68" textAnchor="middle" fontSize="8" fontWeight="600" fill={C.muted}>Bold</text>
        </g>

        {/* Dashed note */}
        <g transform="translate(240, 10)">
          <rect width="100" height="48" rx="6" fill="rgba(234,179,8,0.08)" stroke={C.yellow} strokeWidth="1.5" strokeDasharray="6 4" />
          <rect x="12" y="10" width="50" height="5" rx="2.5" fill={C.yellow} opacity="0.3" />
          <rect x="12" y="20" width="70" height="3" rx="1.5" fill={C.muted} opacity="0.15" />
          <rect x="12" y="28" width="60" height="3" rx="1.5" fill={C.muted} opacity="0.12" />
          <text x="50" y="68" textAnchor="middle" fontSize="8" fontWeight="600" fill={C.muted}>Note</text>
        </g>

        {/* Rounded soft */}
        <g transform="translate(360, 10)">
          <rect width="100" height="48" rx="14" fill="rgba(139,92,246,0.08)" stroke="#8b5cf6" strokeWidth="1.5" />
          <rect x="12" y="10" width="36" height="28" rx="6" fill="rgba(139,92,246,0.12)" />
          <rect x="54" y="14" width="32" height="4" rx="2" fill={C.muted} opacity="0.2" />
          <rect x="54" y="24" width="24" height="3" rx="1.5" fill={C.muted} opacity="0.12" />
          <text x="50" y="68" textAnchor="middle" fontSize="8" fontWeight="600" fill={C.muted}>Soft</text>
        </g>
      </g>
    </svg>
  )
