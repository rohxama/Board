...
export function useKeyboardShortcuts({ dispatch, undo, redo, remove, nudge, duplicate, copy, paste, selectAll, deselect }) {
  ...
  }; window.addEventListener('keydown', keydown); return () => window.removeEventListener('keydown', keydown) }, [dispatch, undo, redo, remove, nudge, duplicate, copy, paste, selectAll, deselect])
}
